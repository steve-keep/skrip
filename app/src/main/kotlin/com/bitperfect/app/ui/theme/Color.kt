...
val SecondaryLight = Color(0xFF6F48B2)
val OnSecondaryLight = Color(0xFFFFFFFF)
val SecondaryContainerLight = Color(0xFFB78EFE)
val OnSecondaryContainerLight = Color(0xFF491D8A)
...
val OnSecondaryDark = Color(0xFF260058)
val SecondaryContainerDark = Color(0xFF572E99)
val OnSecondaryContainerDark = Color(0xFFEBDCFF)

val TertiaryDark = Color(0xFFFFB784)
val OnTertiaryDark = Color(0xFF301400)
val TertiaryContainerDark = Color(0xFF713700)
val OnTertiaryContainerDark = Color(0xFFFFDCC6)

val BackgroundDark = Color(0xFF191C20)
...
val SurfaceContainerDark = Color(0xFF2E3135)
val SurfaceContainerHighDark = Color(0xFF33363A)
...
// BitPerfect Precision Audio Tool Palette (Design Tokens)
val BgBase = Color(0xFF0A0A0A)
val BgSurface = Color(0xFF141414)
val BgSurfaceRaised = Color(0xFF1C1C1C)
val BgSurfaceHover = Color(0xFF222222)
val AccentPrimary = Color(0xFF3DDC68)
val AccentPrimaryDim = Color(0xFF2AAF4F)
val AccentPrimarySubtle = Color(0x1F3DDC68) // rgba(61,220,104,0.12)
val ColorSuccess = Color(0xFF3DDC68)
val ColorError = Color(0xFFE53935)
val ColorWarning = Color(0xFFF5A623)
val ColorInfoBlue = Color(0xFF2979FF)
val BorderDefault = Color(0x14FFFFFF) // rgba(255,255,255,0.08)
val BorderInput = Color(0x1EFFFFFF) // rgba(255,255,255,0.12)
